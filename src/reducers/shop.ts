...
const shop = (state = { products: {}, cart: INITIAL_CART }, action: any) => { // TODO: switch from any to a more specific action type
  switch (action.type) {
    case GET_PRODUCTS:
      return {
        ...state,
...
const products = (state: any, action: any) => { // TODO: switch from any to a more specific action type
  switch (action.type) {
    case ADD_TO_CART:
    case REMOVE_FROM_CART:
...
const product = (state: any, action: any) => { // TODO: switch from any to a more specific action type
  switch (action.type) {
    case ADD_TO_CART:
      return {
        ...state,
...
const cart = (state = INITIAL_CART, action: any) => { // TODO: switch from any to a more specific action type
  switch (action.type) {
    case ADD_TO_CART:
    case REMOVE_FROM_CART:
      return {
...
const quantityById = (state = INITIAL_CART.quantityById, action: any) => { // TODO: switch from any to a more specific action type
  const productId = action.productId;
  switch (action.type) {
    case ADD_TO_CART:
      return {
